...
void controller()
{
 controlP5 = new ControlP5(this);
  ...
  Controller mySlider8 = controlP5.addSlider("startX",0,inputWidth,40,130,120,20);
   ...
   mySlider8.setColorActive(color(250,75,0));
  Controller mySlider9 = controlP5.addSlider("startY",0,inputHeight,210,130,120,20);
   ...
   mySlider9.setColorActive(color(250,75,0));
  ...
  Controller mySlider7 = controlP5.addSlider("noiseR",0,0.5,40,160,150,20);
   ...
   mySlider7.setColorActive(color(250,75,0));
  ...
  //Quicktime only controlP5.Button a = controlP5.addButton("Cam",10,300,70,60,20); 
  //Quicktime only  a.setWindow(controlWindow);
  //Quicktime only  a.setId(1);
  ...
  controlP5.Button c =controlP5.addButton("Save Image",10,300,40,60,20);
   ...
   c.setId(3); 
  /*controlP5.Button h =controlP5.addButton("Save *.obj Mesh",10,40,230,100,20);
   h.setColorActive(color(200,50,0));
   h.setColorBackground(color(100,25,0));
...
void controlEvent(ControlEvent theEvent) {
  ...
  switch(theEvent.controller().id()) {
    ...
    //Quicktime only case(1):
    //Quicktime only Img.settings();
    //Quicktime only break;
    case(2):
